...
//TODO: This will get removed when socket_addresses.rs is complete.
...
pub fn get_address_info(host: &str, service: &str) -> Result<AddressInfoIterator, String> {
  ...
  unsafe {
    ...
    if errno != 0 { 
      //TODO: investigate if gai_strerror allocates or if it's another one of those static string good ideazzzzzz.
